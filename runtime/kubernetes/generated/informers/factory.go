...
import (
	...
	vela "github.com/go-vela/worker/runtime/kubernetes/generated/informers/vela"
...
func (f *sharedInformerFactory) Vela() vela.Interface {
	return vela.New(f, f.namespace, f.tweakListOptions)
}
